...
// Auto-load sample data when page loads (for demo purposes)
window.addEventListener('load', function() {
  // Wait a bit for Firebase to initialize
  setTimeout(() => {
    if (window.FirebaseHelper && window.location.pathname.includes('app.html')) {
      // Only load sample data on app page and if no products exist
      window.FirebaseHelper.getProducts().then(result => {
...
console.log('Sample data script loaded. Available functions:');
console.log('- loadSampleData(): Load sample products');
console.log('- createDemoAccount(): Create demo account');
console.log('- Demo account: demo@benangrejut.com / demo123456'); 